package com.xiaochj.accessbility;
...
import com.xiaochj.utils.Utils;

import java.util.List;

public class LedAccessibilityService extends android.accessibilityservice.AccessibilityService {
...
//		Utils.LogUtil("d", TAG, moneyStr);
		Utils.ToastUtil(getApplicationContext(),moneyStr);
		performGlobalAction(GLOBAL_ACTION_BACK);
	}
